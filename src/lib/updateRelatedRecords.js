...
var BASE_URL_RAW = 'https://crm.zoho.com/crm/private/json/%s/updateRelatedRecords';
...
/**
 * Update 1 related record to zoho based on the Id
 * @param {string} authToken
 * @param {string} moduleName
 * @param {Object} rawParams - Key value to be passed in parameters, follow zoho's guide https://www.zoho.com/crm/help/api/updateRelatedRecords.html
...
module.exports = function (authToken, moduleName, rawParams) {
  ...
  var params = {
    ...
    scope: 'crmapi',
    id: rawParams.id,
    relatedModule: rawParams.relatedRecord,
    xmlData: helper.toXmlData(rawParams.relatedRecord, rawParams.data)
  };
